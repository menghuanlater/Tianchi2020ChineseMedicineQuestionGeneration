...
if __name__ == "__main__":
    ...
    args = {
        ...
        "min_lr_rate": 1e-9,
        "save_interval": 1000,
        "save_path": "ModelStorage/xl_dureader_drmc.pth",
        "load_path": "ModelStorage/xl_dureader.pth",
    ...
    if sys.argv[1] == "train":
        ...
        writer = SummaryWriter(logdir="RunLog/Multi-DRMC")
        train_dataset = MyDataset(data=x["drcd_train_items"] + x["cmrc_train_items"], max_enc_len=args["max_enc_len"],
